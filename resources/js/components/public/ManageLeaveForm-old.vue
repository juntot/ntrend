                ...
                <div class="col-lg-12">
                    <div class="col-lg-4">
                        <div @click="hasCredits('SL')">
                            ...
                            <input :disabled="$parent.disabledinput || disableSL" type="radio" v-model="leavetype" value="1" name="radio" checked="checked" >
                            <span class="checkmark"></span>
                            </label>
                        </div>
                        <div @click="hasCredits('BL'), validateLess7Days()">
                            <label class="mdblblradio">
                            <span class="checklbl">Birthday Leave</span>
                            <input :disabled="$parent.disabledinput || $parent.disableLeaveType || disableBL" type="radio" v-model="leavetype" value="2" name="radio">
                            <span class="checkmark"></span>
                            </label>
                        </div>
                        <div >
                            ...
                            <input :disabled="$parent.disabledinput" type="radio" v-model="leavetype" value="3" name="radio">
                            <span class="checkmark"></span>
                            </label>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div>
                            ...
                            <input :disabled="$parent.disabledinput" type="radio" v-model="leavetype" value="4" name="radio">
                            <span class="checkmark"></span>
                            </label>
                        </div>
                        <div @click="hasCredits('VL'), validateLess7Days()">
                            <label class="mdblblradio">
                            <span class="checklbl">Vacation Leave</span>
                            <input :disabled="$parent.disabledinput || $parent.disableLeaveType || disableVL" type="radio" v-model="leavetype" value="5" name="radio">
                            <span class="checkmark"></span>
                            </label>
                        </div>
                        <div @click="hasCredits('DL')">
                            ...
                            <input :disabled="$parent.disabledinput || disableDL" type="radio" v-model="leavetype" value="6" name="radio">
                            <span class="checkmark"></span>
                            </label>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div>
                            ...
                            <input :disabled="$parent.disabledinput" type="radio" v-model="leavetype" value="7" name="radio">
                            <span class="checkmark"></span>
                            </label>
                        </div>
                        <div>
                            ...
                            <input :disabled="$parent.disabledinput" type="radio" v-model="leavetype" value="8" name="radio">
                            <span class="checkmark"></span>
                            </label>
                        </div>
                        <div>
                            ...
                            <input :disabled="$parent.disabledinput" type="radio" v-model="leavetype" value="9" name="radio">
                            <span class="checkmark"></span>
                            </label>
                        </div>
                    </div>
...
export default {
    ...
    methods:{
        ...
        selectDateStart(val){
            this.datestart = moment(val).format('MM/DD/YYYY');
            if(!this.isValidType){
        ...
        selectDateEnd(val){
            ...
            this.dateend = moment(val).format('MM/DD/YYYY');
            // this.validateLess7Days();
        },
        validateLess7Days(){
    ...
    mounted(){
        ...
        // $('#myModal').on("shown.bs.modal", this.onOpenModal);
