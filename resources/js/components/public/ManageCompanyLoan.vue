<template>
    <div>
        ...
        <div class="col-md-12">
            <div class="mdb-form-field form-group-limit">
                <div class="form-field__control">
                    <input :disabled="$parent.disabledinput" type="text" class="form-field__input" :value="datefiled" name="date filed" readonly="true">
        ...
        <div class="col-md-4">
            <div class="mdb-form-field form-group-limit">
                <div class="form-field__control">
                    <input :disabled="$parent.disabledinput" type="text" class="form-field__input" :value="computedfullname" name="name" readonly="true">
        ...
        <div class="col-md-4">
            <div class="mdb-form-field form-group-limit">
                <div class="form-field__control">
                    <input :disabled="$parent.disabledinput" type="text" class="form-field__input" :value="computedContact" name="contactnum" readonly="true">
        ...
        <div class="col-md-4">
            <div class="mdb-form-field form-group-limit">
                <div class="form-field__control">
                    <input :disabled="$parent.disabledinput" type="text" class="form-field__input" :value="computedAddress" name="address" readonly="true">
        ...
        <div class="col-md-4">
            <div class="mdb-form-field form-group-limit">
                <div class="form-field__control">
                    <input :disabled="$parent.disabledinput" type="text" class="form-field__input" :value="userinfo.dhired"  name="date-hired" readonly="true">
        ...
        <div class="col-md-4">
            <div class="mdb-form-field form-group-limit">
                <div class="form-field__control">
                    <input :disabled="$parent.disabledinput" type="text" class="form-field__input" :value="computeddept_branchname" name="dept/branch" readonly="true">
        ...
        <div class="col-md-4">
            <div class="mdb-form-field form-group-limit">
                <div class="form-field__control">
                    <input :disabled="$parent.disabledinput" type="text" class="form-field__input" v-model="bankname" v-validate="'required'" name="bankname">
        ...
        <div class="col-md-4">
            <div class="mdb-form-field form-group-limit">
                <div class="form-field__control">
                    <input :disabled="$parent.disabledinput" type="text" class="form-field__input" v-model="bankaccount" v-validate="'required'" name="banck-acount-number">
        ...
        <div class="col-md-4">
            <div class="mdb-form-field form-group-limit">
                <div class="form-field__control">
                    <input :disabled="$parent.disabledinput" type="text" class="form-field__input" v-model="loanamount" v-validate="'required'" name="loan-amount" >
        ...
        <div class="col-md-12">
            <div>
                ...
                <input :disabled="$parent.disabledinput" type="radio" v-model="loantype" value="1" name="loantype"> 
            ...
            <div>
                ...
                <input :disabled="$parent.disabledinput" type="radio" v-model="loantype" value="2" name="loantype"> 
                <span class="checkmark"></span>
                </label>
                <div class="col-md-12 blockindent">
                        <div><em>Requirements</em></div>
            ...
            <div>
                ...
                <input :disabled="$parent.disabledinput" type="radio" v-model="loantype" value="3" name="loantype" @blur="MDBINPUT"> 
                <span class="checkmark"></span>
                </label>
                <div class="col-md-12 blockindent">
                        <div><em>Requirements</em></div>
                ...
                <div class="col-md-12">
                        <div class="mdb-form-field form-group-limitx">
                            <div class="form-field__control">
                                <input :disabled="$parent.disabledinput" type="text" class="form-field__input" v-model="specialsituation" name="situation" >
            ...
            <div>
                ...
                <input :disabled="$parent.disabledinput" type="radio" v-model="loantype" value="4" name="loantype"> 
                <span class="checkmark"></span>
                </label>
                <div class="col-md-12 blockindent">
                        <div><em>Requirements</em></div>
            ...
            <div>
                ...
                <input :disabled="$parent.disabledinput" type="radio" v-model="loantype" value="5" name="loantype"> 
                <span class="checkmark"></span>
                </label>
                <div class="col-md-12 blockindent">
                        <div><em>Requirements</em></div>
                ...
                <div class="col-md-6">
                        <div class="mdb-form-field form-group-limit">
                            <div class="form-field__control">
                                <input :disabled="$parent.disabledinput" type="text" class="form-field__input" v-model="paymentperiod" name="payment-period">
                ...
                <div class="col-md-6">
                        <div class="mdb-form-field form-group-limit">
                            <div class="form-field__control">
                                <input :disabled="$parent.disabledinput" type="text" class="form-field__input" v-model="incentives" name="incentives">
            ...
            <div class="col-md-12">
                <div class="group">
                    ...
                    <input :disabled="$parent.disabledinput" type="checkbox" v-model="eula" value="true"> 
            ...
            <div class="modal-footer">
                <input type="submit" class="btn btn-primary" value="Submit" @click.prevent="addLoan" :disabled="disabledIfNoApprover || isDisable || !isFormValid || !eula" v-if="submitBtn">
...
export default {
    ...
    computed:{
        ...
        submitBtn()
        {
            return !this.loanID && this.$parent.$data.forapprover != 'approval';
        },
        updateDeleteBtn(){
            return this.loanID && this.$parent.$data.forapprover != 'approval' && !this.$parent.disabledinput 
        },
        approveRejecBtn(){
