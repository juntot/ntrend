            ...
            <form method="post">
                ...
                <div class="col-md-8">
                            <div class="form-group-limit">
                                        <Datepicker :disabled="$parent.disabledinput" :value="discrepancydate" @selected="selectDateStart" wrapper-class="mdb-form-field" input-class="form-field__input datePicker" :typeable="false" :format="'MM/dd/yyyy'">
...
export default {
    ...
    data() {
		return {
            ...
            discrepancydate: moment(new Date()).format('MM/DD/YYYY'),
            reason: '',
            saldiscID: '',
            approvedby: '',
            remarks: ''
    ...
    computed:{
        ...
        submitBtn()
        {
            return !this.saldiscID && this.$parent.$data.forapprover != 'approval';
        },
        updateDeleteBtn(){
            return this.saldiscID && this.$parent.$data.forapprover != 'approval' && !this.$parent.disabledinput 
        },
        approveRejecBtn(){
