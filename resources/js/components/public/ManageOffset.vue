    ...
    <div>
            <form method="post" >
                            ...
                            <table width="100%" class="table table-hover mdb-table">
                                    <thead>
                                        ...
                                        <tr v-if="!$parent.disabledinput">
                                            <td>
                                                <Datepicker :value="offsetdate" wrapper-class="mdb-form-field" input-class="form-field__input datePicker inline-input" @selected="selectOffsetDate" :typeable="false" :format="'MM/dd/yyyy'">
                ...
                <div class="col-md-8">
                        <div class="mdb-form-field form-group-limit">
                            <div class="form-field__control">
                                <input type="text" class="form-field__input" :value="userinfo.empID" name="idno">
...
export default {
    ...
    computed:{
        ...
        submitBtn()
        {
            return !this.offsetID && this.$parent.$data.forapprover != 'approval';
        },
        updateDeleteBtn(){
            return this.offsetID && this.$parent.$data.forapprover != 'approval' && !this.$parent.disabledinput
        },
        approveRejecBtn(){
