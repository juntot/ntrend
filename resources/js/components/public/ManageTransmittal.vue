<template>
    <div>
            ...
            <form method="post">
                    ...
                    <div class="col-lg-12">
                        <h5 class="form-subtitle"><em>Sender Information:</em></h5>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-lg-12">
                        <h5 class="form-subtitle"><em>Receiver Information:</em></h5>
                    </div>
                    <div class="col-md-4">
                        <div class="mdb-form-field form-group-limit">
                    ...
                    <div class="col-md-4">
                        <div class="mdb-form-field form-group-limit">
                            <div class="form-field__control">
                                ...
                                <label class="form-field__label">Receiver Branch</label>
                                <div class="form-field__bar"></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mdb-form-field form-group-limit">
                            <div class="form-field__control">
                                <input :disabled="$parent.disabledinput" v-validate="'required'" type="text" class="form-field__input" v-model="contactnum" name="contactnumber">
                                <label class="form-field__label">Contact Number</label>
                                <div class="form-field__bar"></div>
                            </div>
                            <span class="errors">{{ errors.first('contactnumber') }}</span>
                        </div>
                    </div>
                    <!-- <div class="col-md-4">
                        <div class="mdb-form-field form-group-limit">
                            <div class="form-field__control">
                                <input :disabled="$parent.disabledinput" type="text" class="form-field__input" v-model="address" name="lastname">
                    ...
                    <div class="col-md-4">
                            <div class="mdb-form-field form-group-limit form-field--is-active">
                                <div class="form-field__control">
                                    <select :disabled="$parent.disabledinput" v-model="address" id="posname" name="position" v-validate="'required'" class="form-field__input">
                                        <option :value="' '" disabled >Choose Address</option>    
                                        <option :value="item.addressName" v-for="(item, key) in computedAddressList" :key="key">{{ item.addressName }}</option>
                                    </select>
                                    <label class="form-field__label">Address</label>
                                    <div class="form-field__bar"></div>
                                </div>
                                                ...
                                                <td>
                                                    <div class="mdb-form-field form-group-limitx">
                                                        <div class="form-field__control form-field--is-filled">
                                                            <input type="text" name="doctype" v-model="doctype" class="form-field__input inline-input" >
                                                            <div class="form-field__bar"></div>
                                                        </div>
                                                        <span class="errors">{{ errors.first('doctype') }}</span>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="mdb-form-field form-group-limitx">
                                                        <div class="form-field__control form-field--is-filled">
                                                            <input type="text" name="refnum" v-model="refnum" class="form-field__input inline-input" >
                                                            <div class="form-field__bar"></div>
                                                        </div>
                                                        <span class="errors">{{ errors.first('refnum') }}</span>
                                                    </div>
                                                </td>
                                                <!-- <td>
...
export default {
    ...
    methods:{
        ...
        selectedEmployee(val) {
            ...
            this.receiver_pos = val.receiver_pos;
            this.receiver_branch = val.receiver_branch;
            this.receiver_dept = val.receiver_dept;
            this.MDBINPUT();
        ...
        addTransmittal(){
            if(this.isFormValid)
            {
                ...
                params['request_type'] = this.request_type.toString();
                axios.post('api/addtransmittal', params).then(({data})=>{
                    this.$parent.addRow({...data, search_employee: this.search_employee,
                        receiver_pos: this.receiver_pos,
                        receiver_branch: this.receiver_branch,
                        receiver_dept: this.receiver_dept,
                    });
                    $("#myModal").modal("hide");
        ...
        closeModal(){
            ...
            Object.keys(obj).forEach((key)=>{
                if(
                    key != 'employeeList' && key != 'addressList'
                )
                    this.$data[key] = '';
                if(key=='isDisable'){
                    this.$data[key] = false;
    ...
    computed:{
        computedAddressList(){
            const receiverBranch = this.receiver_branch || '';
            return this.addressList.filter(addr => addr.branchname == receiverBranch);
        },
        isFormValid(){
    ...
    created(){
        ...
        .then(res=>this.addressList = res.data)
