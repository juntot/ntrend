                    ...
                    <h5 class="form-subtitle">
                        <em class="text-center relative-pos">
                            ...
                            <div class="col-md-7 text-left nopadding" v-show="$parent.disabledinput">
                                LEAVE CALENDAR <i class="far fa-calendar-alt" style="cursor: pointer"  @click="invokeParent"></i>
                            </div>
                            <div class="clearfix"></div>
                        </em>
                    </h5>
...
export default {
    ...
    methods:{
        ...
        deleteLeave(){
            this.isDisable = true;
            const params = {
                reciever_emails: this.$parent.reciever_emails
            };
            axios.post('api/deleteleave/'+this.leaveID, params).then((response)=>{
