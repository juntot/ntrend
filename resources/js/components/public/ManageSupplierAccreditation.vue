<template>
    <div>
            ...
            <form method="get">
                <h3 class="text-center form-title"><span class="dblUnderlined">SUPPLIER ACCREDITATION</span></h3>
                <div class="col-lg-12">
                ...
                <div class="col-md-6">
                    <div class="mdb-form-field">
                        <div class="form-field__control">
                            <input :disabled="$parent.disabledinput" type="text" class="form-field__input" v-model="supname" name="Supplier's Name">
                ...
                <div class="col-md-6">
                    <div class="mdb-form-field">
                        <div class="form-field__control">
                            <input :disabled="$parent.disabledinput" type="text" class="form-field__input" v-model="supheadoffice" name="Head Office Address">
                ...
                <div class="col-md-6">
                    <div class="mdb-form-field">
                        <div class="form-field__control">
                            <input :disabled="$parent.disabledinput" type="text" class="form-field__input" v-model="supbranchadd" name="Branch Address">
                ...
                <div class="col-md-6">
                    <div class="mdb-form-field">
                        <div class="form-field__control">
                            <input :disabled="$parent.disabledinput" type="text" class="form-field__input" v-model="product" name="Product/Service">
                ...
                <div class="col-md-6">
                    <div class="mdb-form-field">
                        <div class="form-field__control">
                            <input :disabled="$parent.disabledinput" type="text" class="form-field__input" v-model="website" name="Website">
                ...
                <div class="col-md-6">
                    <div class="mdb-form-field">
                        <div class="form-field__control">
                            <input :disabled="$parent.disabledinput" type="text" class="form-field__input" v-model="contactperson" name="Contact Person">
                ...
                <div class="col-md-3">
                    <div class="mdb-form-field form-group-limit">
                        <div class="form-field__control">
                            <input :disabled="$parent.disabledinput" type="text" class="form-field__input" v-model="phone" name="Phone num">
                ...
                <div class="col-md-3">
                    <div class="mdb-form-field form-group-limit">
                        <div class="form-field__control">
                            <input :disabled="$parent.disabledinput" type="text" class="form-field__input" v-model="mobile" name="Mobile num">
                ...
                <div class="col-md-3">
                    <div class="mdb-form-field form-group-limit">
                        <div class="form-field__control">
                            <input :disabled="$parent.disabledinput" type="text" class="form-field__input" v-model="fax" name="Fax num">
                ...
                <div class="col-md-3">
                    <div class="mdb-form-field form-group-limit">
                        <div class="form-field__control">
                            <input :disabled="$parent.disabledinput" type="text" class="form-field__input" v-model="TIN" name="TIN">
                ...
                <div class="col-md-3">
                    <div class="mdb-form-field form-group-limit">
                        <div class="form-field__control">
                            <input :disabled="$parent.disabledinput" type="text" class="form-field__input" v-model="SECDTIregno" name="SEC/DTI Reg No.">
                ...
                <div class="col-md-3">
                    <div class="form-group-limit">
                            <Datepicker :disabled="$parent.disabledinput" :value="datereg" @selected="selectDateReg" wrapper-class="mdb-form-field" input-class="form-field__input datePicker" :typeable="false" format="yyyy-MM-dd">
                ...
                <div class="col-md-3">
                    <div class="mdb-form-field form-group-limit">
                        <div class="form-field__control">
                            <input :disabled="$parent.disabledinput" type="text" class="form-field__input" v-model="philhealth" name="Philhealth">
                ...
                <div class="col-md-3">
                    <div class="mdb-form-field form-group-limit">
                        <div class="form-field__control">
                            <input :disabled="$parent.disabledinput" type="text" class="form-field__input" v-model="sss" name="SSS Number">
                ...
                <div class="col-md-3">
                    <div class="mdb-form-field form-group-limit">
                        <div class="form-field__control">
                            <input :disabled="$parent.disabledinput" type="text" class="form-field__input" v-validate="'required|numeric'" v-model="yearinbusiness" name="Year in Business">
                ...
                <div class="col-md-3">
                    <div class="mdb-form-field form-group-limit">
                        <div class="form-field__control">
                            <input :disabled="$parent.disabledinput" type="text" class="form-field__input" v-model="capital" name="Total Capitalization">
                ...
                <div class="col-md-3">
                    <div class="mdb-form-field form-group-limit">
                        <div class="form-field__control">
                            <input :disabled="$parent.disabledinput" type="text" class="form-field__input" v-model="asset" name="Total Asset">
                ...
                <div class="col-md-3">
                    <div class="mdb-form-field form-group-limit">
                        <div class="form-field__control">
                            <input :disabled="$parent.disabledinput" type="text" class="form-field__input" v-model="liabilities" name="Total Liabilities">
                ...
                <div class="col-md-3">
                        <div class="mdb-form-field form-group-limit">
                            <div class="form-field__control">
                                <input :disabled="$parent.disabledinput" type="text" class="form-field__input" v-model="industry" name="Industry">
                    ...
                    <div class="col-md-3">
                        <div class="mdb-form-field form-group-limit">
                            <div class="form-field__control">
                                <input :disabled="$parent.disabledinput" type="text" class="form-field__input" v-validate="'required|numeric'" v-model="totalemployees" name="No. of Employees">
                    ...
                    <div class="col-md-3">
                        <div class="mdb-form-field form-group-limit">
                            <div class="form-field__control">
                                <input :disabled="$parent.disabledinput" type="text" class="form-field__input" v-validate="'required|numeric'" v-model="regemployee" name="No. of Regular Employees">
                    ...
                    <div class="col-md-3">
                        <div class="mdb-form-field form-group-limit">
                            <div class="form-field__control">
                                <input :disabled="$parent.disabledinput" type="text" class="form-field__input" v-validate="'required|numeric'" v-model="activeclient" name="No.of active clients">
                ...
                <div class="col-md-12">
                    <div class="col-md-6">
                        <div class="group"> 
                            ...
                            <input :disabled="$parent.disabledinput" type="checkbox" v-model="docu1" value="1">
                        ...
                        <div class="group"> 
                            ...
                            <input :disabled="$parent.disabledinput" type="checkbox" v-model="docu2" value="1">
                            <span class="mdbcheckmark"></span>
                            </label>
                        </div>
                        <div class="group"> 
                            ...
                            <input :disabled="$parent.disabledinput" type="checkbox" v-model="docu3" value="1">
                            <span class="mdbcheckmark"></span>
                            </label>
                        </div>
                        <div class="group"> 
                            ...
                            <input :disabled="$parent.disabledinput" type="checkbox" v-model="docu4" value="1">
                            <span class="mdbcheckmark"></span>
                            </label>
                        </div>
                        <div class="group"> 
                            ...
                            <input :disabled="$parent.disabledinput" type="checkbox" v-model="docu5" value="1">
                            <span class="mdbcheckmark"></span>
                            </label>
                        </div>
                        <div class="group"> 
                            ...
                            <input :disabled="$parent.disabledinput" type="checkbox" v-model="docu6" value="1">
                            <span class="mdbcheckmark"></span>
                            </label>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="group"> 
                            ...
                            <input :disabled="$parent.disabledinput" type="checkbox" v-model="docu7" value="1">
                            <span class="mdbcheckmark"></span>
                            </label>
                        </div>
                        <div class="group"> 
                            ...
                            <input :disabled="$parent.disabledinput" type="checkbox" v-model="docu8" value="1">
                            <span class="mdbcheckmark"></span>
                            </label>
                        </div>
                        <div class="group"> 
                            ...
                            <input :disabled="$parent.disabledinput" type="checkbox" v-model="docu9" value="1">
                            <span class="mdbcheckmark"></span>
                            </label>
                        </div>
                        <div class="group"> 
                            ...
                            <input :disabled="$parent.disabledinput" type="checkbox" v-model="docu10" value="1">
                            <span class="mdbcheckmark"></span>
                            </label>
                        </div>
                        <div class="group"> 
                            ...
                            <input :disabled="$parent.disabledinput" type="checkbox" v-model="docu11" value="1">
                            <span class="mdbcheckmark"></span>
                            </label>
                        </div>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="mdb-form-field form-group-limit">
                        <div class="form-field__control">
                            <input :disabled="$parent.disabledinput" type="text" class="form-field__input" v-model="bankname" name="Bank/Branch">
                ...
                <div class="col-md-4">
                    <div class="mdb-form-field form-group-limit">
                        <div class="form-field__control">
                            <input :disabled="$parent.disabledinput" type="text" class="form-field__input" v-model="accountno" name="Account No">
                ...
                <div class="col-md-4">
                    <div class="mdb-form-field form-group-limit">
                        <div class="form-field__control">
                            <input :disabled="$parent.disabledinput" type="text" class="form-field__input" v-model="accountname" name="Account Name">
                ...
                <!-- <div class="col-md-12">
                    <div class="col-md-2">
                        <div>
                            ...
                            <input :disabled="$parent.disabledinput" type="radio" v-model="payterms" value="1" name="radio" checked="checked">
                ...
                <div class="col-md-12">
                    <div class="mdb-form-field form-group-limit">
                        <div class="form-field__control">
                            <input :disabled="$parent.disabledinput" type="text" v-model="payterms" class="form-field__input" name="Others">
                ...
                <div class="col-md-12">
                    <div class="col-md-2">
                        <div>
                            ...
                            <input :disabled="$parent.disabledinput" type="radio" v-model="modepayment" value="1" name="radio" checked="checked">
                            <span class="checkmark"></span>
                            </label>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div>
                            ...
                            <input :disabled="$parent.disabledinput" type="radio" v-model="modepayment" value="2" name="radio" checked="checked">
                            <span class="checkmark"></span>
                            </label>
                        </div>
                    </div>
                    <div class="col-md-8">
                        <div>
                            ...
                            <input :disabled="$parent.disabledinput" type="radio" v-model="modepayment" value="3" name="radio" checked="checked">
                            <span class="checkmark"></span>
                            </label>
                        </div>
                    </div>
                ...
                <div class="col-md-12">
                    <div class="mdb-form-field">
                        <div class="form-field__control">
                            <input :disabled="$parent.disabledinput" type="text" class="form-field__input" v-model="productcommitment" name="Specify here">
                ...
                <div class="col-md-12">
                    <div class="mdb-form-field">
                        <div class="form-field__control">
                            <input :disabled="$parent.disabledinput" type="text" class="form-field__input" v-model="productquality" name="Specify here">
                            <label class="form-field__label">Specify here</label>
                            <div class="form-field__bar"></div>
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="mdb-form-field form-group-limit">
                        <div class="form-field__control">
                            <input :disabled="$parent.disabledinput" type="text" class="form-field__input" v-model="repname" name="Owner/Representative">
                ...
                <div class="modal-footer">
                    <input type="submit" class="btn btn-primary" value="Submit" @click.prevent="addSupplierAccreditation" :disabled="disabledIfNoApprover || isDisable || !isFormValid" v-if="submitBtn">
...
export default {
    ...
    computed:{
        ...
        submitBtn()
        {
            return !this.accredID && this.$parent.$data.forapprover != 'approval';
        },
        updateDeleteBtn(){
            return this.accredID && this.$parent.$data.forapprover != 'approval' && !this.$parent.disabledinput 
        },
        approveRejecBtn(){
