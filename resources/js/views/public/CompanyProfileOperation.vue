    ...
    <div>
        ...
        <div class="col-lg-12 canvas-chart margin-15">
            <div class="comp-profile-container">
                ...
                <!-- <div class="col-md-4">
                    <div class="comp-profile-img-overlay dflex">
                        <img :src="'public/images/priemer_jacket.jpg'" class="" style="width:100%; object-fit: cover; height: 100%" alt="Avatar">
                        <div style="position: absolute; top: 50%; z-index: 1; transform: translateY(-50%)" class="col-sm-12">
                            <table>
                                <tr style="vertical-align: top;">
                                    <td style="padding-right: 8px; width: 50px;" class="bold-weight">Title</td>
                                ...
                                <tr style="vertical-align: top;">
                                    <td style="padding-right: 8px" class="bold-weight">Email</td>
                                    <td>juan.dela.curz@northtrend.com.ph</td>
                                </tr>
                            </table>
                        </div>
                    </div>
...
export default {
    ...
    mounted() {
        axios.get('api/get-comp-profile-secondary/s2')
        .then(res=>{
