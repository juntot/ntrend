    ...
    <div>
            ...
            <form method="post" >
                    ...
                    <div class="col-md-2 col-xs-6">
                        <div>
                            <label class="mdblblradio">
                                ...
                                <input :disabled="true" type="radio" value="1" v-model="brand" name="brand">
                    ...
                    <div class="col-md-2 col-xs-6">
                        <div>
                            <label class="mdblblradio">
                                ...
                                <input :disabled="true" type="radio" value="2" v-model="brand" name="brand">
                                <span class="checkmark"></span>
                            </label>
                        </div>
                    </div>
                    <div class="col-md-2 col-xs-6">
                        <div>
                            <label class="mdblblradio">
                                ...
                                <input :disabled="true" type="radio" value="3" v-model="brand" name="brand">
                                <span class="checkmark"></span>
                            </label>
                        </div>
                    </div>
                    <div class="col-md-2 col-xs-6">
                        <div>
                            <label class="mdblblradio">
                                ...
                                <input :disabled="true" type="radio" value="4" v-model="brand" name="radio">
                                <span class="checkmark"></span>
                            </label>
                        </div>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="mdb-form-field form-group-limit">
                        <div class="form-field__control">
                            <input :disabled="true" type="text" class="form-field__input" v-model="itemtype" name="item type">
                ...
                <div class="col-md-4">
                    <div class="mdb-form-field form-group-limit">
                        <div class="form-field__control">
                            <input :disabled="true" type="text" class="form-field__input" v-model="inventorytype" name="Inventory type">
                ...
                <div class="col-md-4">
                    <div class="mdb-form-field form-group-limit">
                        <div class="form-field__control">
                            <input :disabled="true" type="text" class="form-field__input" v-model="category" name="Category">
                    ...
                    <div class="col-lg-2">
                        <div>
                            <label class="mdblblradio">
                                ...
                                <input :disabled="true" type="radio" value="1" v-model="newitem" name="new item">
                                <span class="checkmark"></span>
                            </label>
                        </div>
                    </div>
                    <div class="col-lg-10">
                        <div>
                            <label class="mdblblradio">
                                ...
                                <input :disabled="true" type="radio" value="2" v-model="newitem" name="new item">
                                <span class="checkmark"></span>
                            </label>
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="mdb-form-field">
                        <div class="form-field__control">
                            <input :disabled="true" type="text" class="form-field__input" v-model="itemdesc" name="Item Description">
                ...
                <div class="col-md-6">
                    <div class="mdb-form-field">
                        <div class="form-field__control">
                            <input :disabled="true" type="text" class="form-field__input" v-model="sapcode" name="SAP Code">
                ...
                <div class="col-md-3">
                    <div class="mdb-form-field form-group-limit">
                        <div class="form-field__control">
                            <input :disabled="true" type="text" class="form-field__input" v-model="itemstatus" name="Status">
                ...
                <div class="col-md-3">
                    <div class="mdb-form-field form-group-limit">
                        <div class="form-field__control">
                            <input :disabled="true" type="text" class="form-field__input" v-model="detailtype" name="Type">
                ...
                <div class="col-md-3">
                    <div class="mdb-form-field form-group-limit">
                        <div class="form-field__control">
                            <input :disabled="true" type="text" class="form-field__input" v-model="itemorigin" name="Origin">
                ...
                <div class="col-md-3">
                    <div class="mdb-form-field form-group-limit">
                        <div class="form-field__control">
                            <input :disabled="true" type="text" class="form-field__input" v-model="warehouse" name="Warehouse">
                ...
                <div class="col-md-3">
                    <div class="mdb-form-field form-group-limit">
                        <div class="form-field__control">
                            <input :disabled="true" type="text" class="form-field__input" v-model="qty" name="Quantity">
                ...
                <div class="col-md-3">
                    <div class="mdb-form-field form-group-limit">
                        <div class="form-field__control">
                            <input :disabled="true" type="text" class="form-field__input" v-model="unitmeasure" name="Unit of meassure">
                ...
                <div class="col-md-3">
                    <div class="mdb-form-field form-group-limit">
                        <div class="form-field__control">
                            <input :disabled="true" type="text" class="form-field__input" v-model="itemcost" name="Item cost">
                ...
                <div class="col-md-3">
                    <div class="mdb-form-field form-group-limit">
                        <div class="form-field__control">
                            <input :disabled="true" type="text" class="form-field__input" v-model="totalcost" name="Total">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="mdb-form-field">
                            <div class="form-field__control mdb-bgcolor">
                                <textarea :disabled="true" class="form-field__textarea"  cols="4" rows="4" v-validate="'required'" v-model="moreinfo" name="additional-info"></textarea>
...
export default {
    ...
    computed:{
        ...
        submitBtn()
        {
            return !this.miisID && this.true;
        },
        updateDeleteBtn(){
            return this.miisID && this.true && !this.true 
        },
        approveRejecBtn(){
    ...
    beforeDestroy(){
        bus.$off('setupdateMIIS', this.test)
    },
    mounted(){
        ...
        // EVENT BUS
        bus.$on('setupdateMIIS', this.setDataForEdit);
