    ...
    <div>
            ...
            <form method="post" >
                ...
                <div class="col-md-4">
                        <div class="mdb-form-field form-group-limit">
                            <div class="form-field__control">
                                <input :disabled="true" type="text" class="form-field__input" v-model="daysdeliver" v-validate="'required|numeric|max_value:360'" name="delivery-days" >
                ...
                <div class="col-md-8">
                        <div class="mdb-form-field form-group-limit">
                            <div class="form-field__control">
                                <input :disabled="true" type="text" class="form-field__input" v-model="terms" v-validate="'required'" name="terms" >
                ...
                <div class="col-md-6">
                        <div class="mdb-form-field">
                            <div class="form-field__control">
                                <input :disabled="true" type="text" class="form-field__input" v-model="compname" v-validate="'required'" name="company" >
                ...
                <div class="col-md-6">
                        <div class="mdb-form-field ">
                            <div class="form-field__control">
                                <input :disabled="true" type="text" class="form-field__input" v-model="contactperson" v-validate="'required'" name="contact-person" >
                ...
                <div class="col-md-12">
                        <div class="col-md-2 col-xs-6">
                                <div>
                                        ...
                                        <input :disabled="true" type="radio" value="1" v-model="withquotation" name="quoatation"> 
                        ...
                        <div class="col-md-10 col-xs-6">
                                <div>
                                        ...
                                        <input :disabled="true" type="radio" value="2" v-model="withquotation" name="quoatation"> 
                                        <span rf="" online="" class="checkmark"></span>
                                        </label>
                                </div> 
                        </div>
...
export default {
    ...
    computed:{
        ...
        submitBtn()
        {
            return !this.canvasID && this.true;
        },
        updateDeleteBtn(){
            return this.canvasID && this.true && !this.true 
        },
        approveRejecBtn(){
    ...
    beforeDestroy(){
        bus.$off('setupdateCanvas', this.setDataForEdit)
    },
    mounted(){
        ...
        // EVENT BUS
        bus.$on('setupdateCanvas', this.setDataForEdit);
