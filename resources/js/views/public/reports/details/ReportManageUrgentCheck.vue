        ...
        <form method="get">
            ...
            <div class="col-md-4">
                <div class="form-group-limit">
                        <Datepicker :disabled="true" wrapper-class="mdb-form-field" name="date" :value="datereleased" @selected="selectedDate" input-class="form-field__input datePicker" :typeable="false" format="yyyy-MM-dd">
            ...
            <div class="col-md-8">
                <div class="mdb-form-field form-group-limit">
                    <div class="form-field__control">
                        <input :disabled="true" type="text" class="form-field__input" v-model="vendor" name="vendor">
            ...
            <div class="col-md-4">
                <div class="mdb-form-field form-group-limit">
                    <div class="form-field__control">
                        <input :disabled="true" type="text" class="form-field__input" v-model="bankname" name="bank-name">
            ...
            <div class="col-md-4">
                <div class="mdb-form-field form-group-limit">
                    <div class="form-field__control">
                        <input :disabled="true" type="text" class="form-field__input" v-model="bankaccount" name="account-number">
            ...
            <div class="modal-footer">
                <!-- <input type="submit" class="btn btn-primary" value="Submit" @click.prevent="addUrgentCheck" :disabled="isDisable || !isFormValid" v-if="!urgentID && true">
                <input type="submit" class="btn btn-primary" value="Update" @click.prevent="updateUrgentCheck" :disabled="isDisable || !isFormValid" v-if="urgentID && true && !true">
                <input type="submit" class="btn btn-primary" value="Delete" @click.prevent="deleteUrgentCheck" :disabled="isDisable" v-if="urgentID && true && !true ">
...
export default {
    ...
    beforeDestroy(){
        bus.$off('setupdateUrgentCheck', this.test)
    },
    mounted(){
        ...
        // EVENT BUS
        bus.$on('setupdateUrgentCheck', this.setDataForEdit);
