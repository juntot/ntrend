    ...
    <div>
       <form method="post">
            ...
            <div class="col-md-4">
                <div class="mdb-form-field form-group-limit">
                    <div class="form-field__control">
                        <input :disabled="true" type="text" class="form-field__input" :value="mobile" name="mobile1" readonly="true">
            ...
            <div class="col-md-4">
                <div class="mdb-form-field form-group-limit">
                    <div class="form-field__control">
                        <input :disabled="true" type="text" class="form-field__input" v-model="mobile2" name="mobile2" >
            ...
            <div class="col-md-4">
                <div class="mdb-form-field form-group-limit">
                    <div class="form-field__control">
                        <input type="text" class="form-field__input" :value="userinfo.email" name="email" readonly="true">
            ...
            <div class="col-md-4">
                <div class="mdb-form-field form-group-limit">
                    <div class="form-field__control">
                        <input :disabled="true" type="text" class="form-field__input" v-model="product" v-validate="'required'" name="product/brand">
            ...
            <div class="col-md-12">
                <div class="col-md-4 col-xs-6">
                    <div class="group"> 
                        ...
                        <input :disabled="true" type="checkbox" v-model="ntmc" value="1">
                    ...
                    <div class="group"> 
                        ...
                        <input :disabled="true" type="checkbox" v-model="apbw" value="0">
                        <span class="mdbcheckmark"></span>
                        </label>
                    </div>
                ...
                <div class="col-md-4 col-xs-6">
                    <div class="group"> 
                        ...
                        <input :disabled="true" type="checkbox" v-model="philcrest" value="1">
                        <span class="mdbcheckmark"></span>
                        </label>
                    </div>
                    <div class="group"> 
                        ...
                        <input :disabled="true" type="checkbox" v-model="tyreplus" value="1">
                        <span class="mdbcheckmark"></span>
                        </label>
                    </div>
                </div>
                <div class="col-md-4 col-xs-12">
                    <div class="group"> 
                        ...
                        <input :disabled="true" type="checkbox" v-model="solid" value="1">
                        <span class="mdbcheckmark"></span>
                        </label>
                    </div>
                </div>
...
export default {
    ...
    computed:{
        ...
        computedMobile(){
            return this.selected.hasOwnProperty('fullname') ? this.selected.mobile  : this.userinfo.branchname;
        },
        computedEmail(){
    ...
    beforeDestroy(){
        bus.$off('setupdateCardReq', this.test)
    },
    mounted(){
        ...
        // EVENT BUS
        bus.$on('setupdateCardReq', this.setDataForEdit);
