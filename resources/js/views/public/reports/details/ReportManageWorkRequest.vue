            ...
            <h3 class="text-center form-title"><span class="dblUnderlined">WORK REQUEST FORM</span></h3>
                ...
                <div class="col-md-4">
                    <div class="mdb-form-field form-group-limitx form-field--is-filled">
                        <div class="form-field__control">
                            <select id="formStat" :disabled="$parent.disabledinput" v-model="status" class="form-field__input" aria-required="true" aria-invalid="false">
                    ...
                    <label for="work__attachment" id="work-attachments">
                        <span class="profile-cam-icon" style="position: relative;"><i class="fas fa-camera"></i></span>
                         <span style="position: relative; left: 10px; bottom: 3px;">
                             ...
                             <a id="file-label2" :href="'storage/app/'+work_attachment" target="_blank" v-show="work_attachment">image - {{work_attachment.split("/")[3]}}</a>
                        </span>
                    </label>
                ...
                <div v-if="$parent.disabledinput">
                    <div class="col-lg-12">
                        ...
                        <div class="mdb-form-field">
                                <div class="form-field__control mdb-bgcolor">
                                    <textarea :disabled="$parent.$data.forapprover != 'approval' || !is_IT_DEPT" class="form-field__textarea"  cols="4" rows="4" v-model="remarks" name="additional-info"></textarea>
                ...
                <div class="modal-footer">
                    ...
                    <input type="submit" class="btn btn-primary" value="Back to Pending" @click.prevent="requestActionWorkRequest(0)" :disabled="isDisable || !isFormValid" v-if="$parent.$data.forapprover != 'approval' && $parent.disabledinput && selected.status == 3">
