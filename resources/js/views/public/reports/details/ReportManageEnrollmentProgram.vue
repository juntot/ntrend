            ...
            <form method="post">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                    ...
                    <label for="prog__attachment2" >
                        <span class="profile-cam-icon" style="position: relative;"><i class="fas fa-camera"></i></span>
                         <span style="position: relative; left: 10px; bottom: 3px;">
                             <span v-show="!progagree_attachment" id="file-label2">Program Agreement</span>
...
export default {
    ...
    methods:{
        ...
        async setDataForEdit(data = null){
            ...
            // return;
            this.MDBINPUT();
            $("#reportEnrollmentProgramModal").modal("show");
        },
        MDBINPUT(){
            this.$nextTick(() => {
                [].forEach.call(
    ...
    computed:{
        ...
        isRequiredFieldsValid(){
            return this.customer_name != '' && this.entries.length > 0 && (this.progagree_attachment != '' || this.progmechanic_attachment != '');
        },
        endorser(){
    ...
    beforeDestroy(){
        bus.$off('setupdateEnrollmentProg', this.test)
    },
    mounted(){
        ...
        // EVENT BUS
        bus.$on('setupdateEnrollmentProg', this.setDataForEdit);
