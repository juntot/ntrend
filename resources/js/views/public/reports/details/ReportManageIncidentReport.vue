        ...
        <form method="post">
            ...
            <div class="col-md-4">
                <div class="form-group-limit">
                        <Datepicker :disabled="true" :value="dateoccured" @selected="selectDateOccured" wrapper-class="mdb-form-field" input-class="form-field__input datePicker" :typeable="false" format="yyyy-MM-dd">
            ...
            <div class="col-md-8">
                <div class="mdb-form-field form-group-limit">
                    <div class="form-field__control">
                        <input :disabled="true" type="text" class="form-field__input" v-model="incidenttime" v-validate="'required'" name="incidenttime">
            ...
            <div class="col-md-4">
                <div class="mdb-form-field form-group-limit">
                    <div class="form-field__control">
                        <input :disabled="true" type="text" class="form-field__input" v-model="personsinvolve" v-validate="'required'" name="persons involved">
            ...
            <div class="col-md-4">
                <div class="mdb-form-field form-group-limit">
                    <div class="form-field__control">
                        <input :disabled="true" type="text" class="form-field__input" v-model="designation" v-validate="'required'" name="designation">
            ...
            <div class="col-md-4">
                <div class="mdb-form-field form-group-limit">
                    <div class="form-field__control">
                        <input :disabled="true" type="text" class="form-field__input" v-model="branch" v-validate="'required'" name="branch">
            ...
            <div class="col-lg-12">
                <div class="col-lg-6">
                    <div>
                        <label class="mdblblradio">
                            ...
                            <input :disabled="true" type="radio" value="1" v-model="incidenttype" name="incident type">
                    ...
                    <div>
                        <label class="mdblblradio">
                            ...
                            <input :disabled="true" type="radio" value="2" v-model="incidenttype" name="incident type">
                            <span class="checkmark"></span>
                        </label>
                    </div>
                    <div>
                        <label class="mdblblradio">
                            ...
                            <input :disabled="true" type="radio" value="3" v-model="incidenttype" name="incident type">
                            <span class="checkmark"></span>
                        </label>
                    </div>
                    <div>
                        <label class="mdblblradio">
                            ...
                            <input :disabled="true" type="radio" value="4" v-model="incidenttype" name="incident type">
                            <span class="checkmark"></span>
                        </label>
                    </div>
                    <div>
                        <label class="mdblblradio">
                            ...
                            <input :disabled="true" type="radio" value="5" v-model="incidenttype" name="incident type">
                            <span class="checkmark"></span>
                        </label>
                    </div>
                    <div>
                        <label class="mdblblradio">
                            ...
                            <input :disabled="true" type="radio" value="6" v-model="incidenttype" name="incident type">
                            <span class="checkmark"></span>
                        </label>
                    </div>
                </div>
                ...
                <div>
                    <label class="mdblblradio">
                        ...
                        <input :disabled="true" type="radio" value="7" v-model="incidenttype" name="incident type">
                        <span class="checkmark"></span>
                    </label>
                </div>
                <div>
                    <label class="mdblblradio">
                        ...
                        <input :disabled="true" type="radio" value="8" v-model="incidenttype" name="incident type">
                        <span class="checkmark"></span>
                    </label>
                </div>
                <div>
                    <label class="mdblblradio">
                        ...
                        <input :disabled="true" type="radio" value="9" v-model="incidenttype" name="incident type">
                        <span class="checkmark"></span>
                    </label>
                </div>
                </div>
                <div class="col-lg-6">
                    <div>
                        <label class="mdblblradio">
                            ...
                            <input :disabled="true" type="radio" value="10" v-model="incidenttype" name="incident type">
                            <span class="checkmark"></span>
                        </label>
                    </div>
                    <div>
                        <label class="mdblblradio">
                            ...
                            <input :disabled="true" type="radio" value="11" v-model="incidenttype" name="incident type">
                            <span class="checkmark"></span>
                        </label>
                    </div>
                    <div>
                        <label class="mdblblradio">
                            ...
                            <input :disabled="true" type="radio" value="12" v-model="incidenttype" name="incident type">
                            <span class="checkmark"></span>
                        </label>
                    </div>
                </div>
            ...
            <div class="col-md-12">
                <div class="mdb-form-field">
                    <div class="form-field__control mdb-bgcolor">
                        <textarea :disabled="true" class="form-field__textarea"  cols="4" rows="4" v-validate="'required'" v-model="details" name="additional-details"></textarea>
            ...
            <div class="col-md-12">
                <div class="mdb-form-field">
                    <div class="form-field__control mdb-bgcolor">
                        <textarea :disabled="true" class="form-field__textarea"  cols="4" rows="4" v-validate="'required'" v-model="actiontaken" name="additional-info"></textarea>
            ...
            <div class="col-md-12">
                <div class="mdb-form-field form-group-limit">
                    <div class="form-field__control">
                        <input :disabled="true" type="text" class="form-field__input" :value="computedfullname" name="reported-by">
            ...
            <div class="modal-footer">
                <!-- <input type="submit" class="btn btn-primary" value="Submit" @click.prevent="addIncidentReport" :disabled="isDisable || !isFormValid" v-if="!incidentID && true">
                    <input type="submit" class="btn btn-primary" value="Update" @click.prevent="updateIncidentReport" :disabled="isDisable || !isFormValid" v-if="incidentID && true && !true">
                    <input type="submit" class="btn btn-primary" value="Delete" @click.prevent="deleteIncidentReport" :disabled="isDisable" v-if="incidentID && true && !true ">
                    <input type="submit" class="btn btn-primary" value="Approve" @click.prevent="requestActionIncidentReport(1)" v-if="incidentID && $parent.$data.forapprover == 'approval' && !$parent.$data.isCancel ">
                    <input type="submit" class="btn btn-primary" value="Reject" @click.prevent="requestActionIncidentReport(2)" v-if="incidentID && $parent.$data.forapprover == 'approval' && !$parent.$data.isCancel">
...
export default {
    ...
    data() {
		return {
            ...
            designation: '',
            branch: '',
			incidenttype: 1, //1 sickleave, 2birth leave, 3leave without pay, 4breavementleave, 5vacationleave, 6others
            incidentID: '',
            approvedby: '',
            details: '',
            actiontaken: '',
    ...
    methods:{
        ...
        setDataForEdit(data = null){
            for(let i in this.$data)
            {
                ...
                this.$data[i] = data[i];
                if(i == 'incidenttype')
                    this.$data[i] = (incidenttype.indexOf(data[i]) + 1);
            
            }
            
            this.MDBINPUT();
            $("#reportIRModal").modal("show");
        },
        ...
        closeModal(){
            ...
            Object.keys(obj).forEach((key)=>{
                ...
                if(key == 'incidenttype' || key == 'totaldays')
                {
                    this.$data[key] = 1;
                }
                if(key=='isDisable'){
    ...
    computed:{
        ...
        submitBtn()
        {
            return !this.supID && this.true;
        },
        updateDeleteBtn(){
            return this.supID && this.true && !this.true 
        },
        approveRejecBtn(){
    ...
    mounted(){
        ...
        // EVENT BUS
        bus.$on('setupdateIR', this.setDataForEdit);
