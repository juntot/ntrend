            ...
            <form method="post">
                ...
                <div class="col-md-8">
                            <div class="form-group-limit">
                                        <Datepicker :disabled="true" :value="date_undertime" wrapper-class="mdb-form-field" input-class="form-field__input datePicker" :typeable="false" :format="'MM/dd/yyyy'">
...
export default {
    ...
    data() {
        ...
        date_undertime: moment(new Date()).format('YYYY-MM-DD'),
    ...
    beforeDestroy(){
        bus.$off('setupdateUndertime', this.test)
    },
    mounted(){
        ...
        // EVENT BUS
        bus.$on('setupdateUndertime', this.setDataForEdit);
