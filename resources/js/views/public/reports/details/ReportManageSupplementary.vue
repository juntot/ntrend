    ...
    <div>
            ...
            <form method="post" >
                                            ...
                                            <td>
                                                <div>
                                                    <span style="padding: 0 12px;">
                                                        <a v-if="!true" @click="removeRow(index)"><i class="fas fa-trash text-danger"></i></a>
                                                    </span>
                        ...
                        <div class="col-md-2 col-xs-6">
                            <div>
                                <label class="mdblblradio">
                                    ...
                                    <input :disabled="true" type="radio" v-model="brand" value="1" name="brand">
                        ...
                        <div class="col-md-2 col-xs-6">
                            <div>
                                <label class="mdblblradio">
                                    ...
                                    <input :disabled="true" type="radio" v-model="brand" value="2" name="brand">
                                    <span class="checkmark"></span>
                                </label>
                            </div>
                        </div>
                        <div class="col-md-2 col-xs-6">
                            <div>
                                <label class="mdblblradio">
                                    ...
                                    <input :disabled="true" type="radio" v-model="brand" value="3" name="brand">
                                    <span class="checkmark"></span>
                                </label>
                            </div>
                        </div>
                        <div class="col-md-2 col-xs-6">
                            <div>
                                <label class="mdblblradio">
                                    ...
                                    <input :disabled="true" type="radio" v-model="brand" value="4" name="brand">
                                    <span class="checkmark"></span>
                                </label>
                            </div>
                        </div>
                ...
                <div class="col-md-8">
                    <div class="mdb-form-field form-group-limit">
                        <div class="form-field__control">
                            <input type="text" class="form-field__input" :value="userinfo.empID" name="idno" :readonly="true">
                ...
                <div class="col-md-12">
                    <div class="mdb-form-field ">
                        <div class="form-field__control">
                            <input :disabled="true" type="text" class="form-field__input" v-model="witnesses" v-validate="'required'" name="witnesses">
                ...
                <div class="clearfix"></div>
                    <div class="modal-footer">
                        <!-- <input type="submit" class="btn btn-primary" value="Print" @click.prevent="addSupplementary" > -->
                        <!-- <input type="submit" class="btn btn-primary" value="Submit" @click.prevent="addSupplementary" :disabled="isDisable || !isFormValid || !hasEntries" v-if="!supID && $parent.$data.forapprover != 'approval'">
                        <input type="submit" class="btn btn-primary" value="Update" @click.prevent="updateSupplementary" :disabled="isDisable || !isFormValid || !hasEntries" v-if="supID && $parent.$data.forapprover != 'approval' && !true">
                        <input type="submit" class="btn btn-primary" value="Delete" @click.prevent="deleteSupplementary" :disabled="isDisable" v-if="supID && $parent.$data.forapprover != 'approval' && !true ">
                        <input type="submit" class="btn btn-primary" value="Approve" @click.prevent="requestActionSupplementary(1)" v-if="supID && $parent.$data.forapprover == 'approval' && !$parent.$data.isCancel ">
                        <input type="submit" class="btn btn-primary" value="Reject" @click.prevent="requestActionSupplementary(2)" v-if="supID && $parent.$data.forapprover == 'approval' && !$parent.$data.isCancel">
                        <input type="submit" class="btn btn-primary" value="Cancel" @click.prevent="requestActionSupplementary(0)" v-if="supID && $parent.$data.forapprover == 'approval' && $parent.$data.isCancel"> -->
                    </div>
            </form>
    </div>
</template>
...
export default {
    ...
    computed:{
        ...
        updateDeleteBtn(){
            return this.supID && this.$parent.$data.forapprover != 'approval' && !this.true
        },
        approveRejecBtn(){
    ...
    beforeDestroy(){
        bus.$off('setupdateSup', this.setDataForEdit)
    },
    mounted(){
        ...
        // EVENT BUS
        bus.$on('setupdateSup', this.setDataForEdit);
