            ...
            <form method="post">
                ...
                <div class="col-lg-12">
                    <div class="mdb-form-field">
                            <div class="form-field__control mdb-bgcolor">
                                <textarea :disabled="true" class="form-field__textarea"  cols="4" rows="4" v-validate="'required'" v-model="purpose" name="additional-info"></textarea>
                ...
                <div class="col-md-12"> 
                        <div class="col-md-2 col-xs-3">
                                <div class="inline-formx">
                                    ...
                                    <input :disabled="true" type="radio" v-model="fixedasset" value="2" name="fixed asset" @click="accountableto=''"> 
                        ...
                        <div class="col-md-10 col-xs-9">
                                <div class="inline-formx">
                                    ...
                                    <input :disabled="true" type="radio" v-model="fixedasset" value="1" name="fixed asset" @click="validateAccountable"> 
                                    <span rf="" online="" class="checkmark"></span>
                                    </label>
                                </div>
                        </div>
                ...
                <!-- <div class="col-md-12" v-show="fixedasset == 1">
                    <div class="col-md-12">
                        <div class="mdb-form-field form-group-limit">
                            <div class="form-field__control">
                                <input :disabled="true" type="text" v-model="accountableto" v-validate="fixedasset != 1?'':'required'" class="form-field__input" name="accountable" >
                ...
                <div class="col-md-12">
                        <div class="col-md-3">
                                <div class="inline-form">
                                    ...
                                    <input :disabled="true" type="radio" v-model="inventoriable" value="1" name="inventoriable"> 
                                    <span rf="" online="" class="checkmark"></span>
                                    </label>
                                </div>
                        </div> 
                        <div class="col-md-3">
                                <div class="inline-form">
                                    ...
                                    <input :disabled="true" type="radio" v-model="inventoriable" value="2" name="inventoriable"> 
                                    <span rf="" online="" class="checkmark"></span>
                                    </label>
                                </div>
                        </div>
                        <div class="col-md-3">
                                <div class="inline-form">
                                    ...
                                    <input :disabled="true" type="radio" v-model="inventoriable" value="3" name="inventoriable"> 
                                    <span rf="" online="" class="checkmark"></span>
                                    </label>
                                </div>
                        </div>
                        <div class="col-md-3">
                                <div class="inline-form">
                                    ...
                                    <input :disabled="true" type="radio" v-model="inventoriable" value="4" name="inventoriable"> 
                                    <span rf="" online="" class="checkmark"></span>
                                    </label>
                                </div>
                        </div>
                ...
                <div class="col-md-12">
                        <div class="mdb-form-field form-group-limit">
                            <div class="form-field__control">
                                <input :disabled="true" type="text" v-model="MRFBDPno" v-validate="'required'" class="form-field__input" name="mrf/bdp" >
...
export default {
    ...
    computed:{
        ...
        updateDeleteBtn(){
            return this.prfID && this.$parent.$data.forapprover != 'approval' && !this.true 
        },
        approveRejecBtn(){
    ...
    beforeDestroy(){
        bus.$off('setupdatePRF', this.test)
    },
    mounted(){

        this.MDBINPUT();
        // MODAL
        $('#PRFModal').on("hidden.bs.modal", this.closeModal);
        // EVENT BUS
        bus.$on('setupdatePRF', this.setDataForEdit);
