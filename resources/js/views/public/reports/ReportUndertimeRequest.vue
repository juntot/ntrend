    ...
    <div>
        ...
        <div class="col-lg-12 margin-15">
            <div class="col-lg-6 col-md-6  with-margin-bottom nopadding">
                <!-- <button class="btn btn-primary" data-toggle="modal" data-target="#undertimeModal">ADD NEW</button> -->
            ...
            <!-- Modal -->
            <div id="undertimeModal" class="modal fade" role="dialog" ref="vuemodal">
                <div class="modal-dialog modal-lg">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <ReportManageUndertimeRequest :userinfo="$root.userinfo" :selected="selected"></ReportManageUndertimeRequest>
                        </div>
                    </div>
                </div>
            </div> <!---END MODAL-->
...
<script>
import ReportManageUndertimeRequest from './details/ReportManageUndertimeRequest';
...
export default {
    ...
    methods:{
        ...
        setUpdate(data){
            bus.$emit('setupdateUndertime', data);
        },
        ...
        downloadXLS(){
            ...
            let rows = [];
            let header = ['EMPLOYEE ID', 'EMPLOYEE NAME', 'COMPANY', 'DEPARTMENT NAME', 'POSITION', 'DATE FILED', 'UNDERTIME DATE','START TIME', 'END TIME', 'TOTAL HOURS', 'REASON', 'APPROVER', 'APPROVED DATE', 'REMARKS', 'STATUS'];
            rows.push(header);
            this.rows.forEach(obj => {
                let records = [
                            obj.empID_, obj.fullname, obj.compname, obj.deptname, obj.posname,
                            obj.datefiled, obj.date_undertime, obj.starttime, obj.endtime, obj.totalhrs,
    ...
    beforeDestroy(){
        bus.$off('initUndertimeReport', this.setInit);
    },
    mounted(){
        let columnDefs = [
        // {
        ...
        // MODAL
        $('#undertimeModal').on("hidden.bs.modal", this.closeModal);
        ...
        bus.$on('initUndertimeReport', this.setInit);
    }
