    ...
    <div>
        ...
        <div class="col-lg-12 margin-15">
            <div class="col-lg-6 col-md-6  with-margin-bottom nopadding">
                <!-- <button class="btn btn-primary" data-toggle="modal" data-target="#leaveModal">ADD NEW</button> -->
            ...
            <!-- Modal -->
            <div id="leaveModal" class="modal fade" role="dialog" ref="vuemodal">
                <div class="modal-dialog modal-lg">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <ReportManageLeaveForm :userinfo="$root.userinfo" :selected="selected"></ReportManageLeaveForm>
                        </div>
                    </div>
                </div>
            </div> <!---END MODAL-->
...
<script>
import ReportManageLeaveForm from './details/ReportManageLeaveForm';
...
export default {
    ...
    methods:{
        ...
        setInit(data = null, stat = null){
            if(stat > 0){
                ...
                $('.approver').text(('APPROVER').toUpperCase());
            }else{
    ...
    beforeDestroy(){
        bus.$off('initLeaveReport', this.setInit);
    },
    mounted(){
        let columnDefs = [
        // {
        //     title: "Leave ID", data: 'leaveID'
        // },
        {
        ...
        bus.$on('initLeaveReport', this.setInit);
