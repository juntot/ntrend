							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								...
								<div class="post-date-diff" style="font-size: 12px; margin: 10px 0px;">
									<div class="dflex justify-space-between">
										...
										<div class="tag-icons">
											<a data-toggle="modal" data-target="#myModalSmall" @click.prevent="showTags(val.tagwith_emp)"><i class="fas fa-users tag-icons"></i></a>
											<a data-toggle="modal" data-target="#myModalSmall" @click.prevent="showTags(val.tagwith_dept)"><i class="fas fa-braille tag-icons"></i></a>
										</div>
									</div>
								</div>
							</div>
