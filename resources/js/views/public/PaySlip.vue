...
/*
var urls = 'https://raw.githubusercontent.com/mozilla/pdf.js/ba2edeae/examples/learning/helloworld.pdf';

// Loaded via <script> tag, create shortcut to access PDF.js exports.
var pdfjsLibx = window['pdfjs-dist/build/pdf'];

// The workerSrc property shall be specified.
pdfjsLibx.GlobalWorkerOptions.workerSrc = '//mozilla.github.io/pdf.js/build/pdf.worker.js';

// Asynchronous download of PDF
var loadingTaskx = pdfjsLibx.getDocument(urls);
loadingTaskx.promise.then(function(pdf) {
