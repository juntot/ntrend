    ...
    <div>
        ...
        <div class="col-lg-12 canvas-chart margin-15">
            ...
            <div class="col-lg-6 col-md-6  with-margin-bottom nopadding" >
                <button class="btn  btn-primary" :disabled="loader || !catSelected.catname" data-toggle="modal" data-target="#modalPolicy">UPLOAD NEW COMPANY PROFILE</button>
            </div>
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <ManageCompProfile :policy="catSelected"></ManageCompProfile>
                        </div>
...
<script>
import ManageCompProfile from '../components/ManageCompProfile';
...
export default {
    ...
    methods:{
       selectedCategory(obj = {}){
           ...
           this.loader = true;
           axios.get('api/get-compprofile-category-details/'+obj.id)
           .then(res=>{
               this.loader = false;
       ...
       addNewCategory(){
           ...
           axios.post('api/add-compprofile-category',params)
           .then(res=>{
               if(res.data){
       ...
       delCategory(){
           ...
           let result = confirm("Are you sure you want to delete?");
            if (result) {
                ...
                axios.get('api/del-compprofile-category/'+id)
                .then(res=>{
       ...
       setUpdate(data){
        ...
        delRow(obj){
            let result = confirm("Are you sure you want to delete?");
            if (result) {
                axios.post('api/del-compprofile-per-detail',{
                    foldername: obj.detail_id,
                    filename: obj.profile_name,
                }).then((res)=>{
                        let row = this.$data.rows;
    ...
    mounted() {
        this.MDBINPUT();
        axios.get('api/get-compprofile-category-all')
        .then(res=>this.category_list = res.data)
        .catch(er=>alert('Server Error'));

        let columnDefs = [{
                title: "PROFILE NAME", data: 'profile_name',
            },{
