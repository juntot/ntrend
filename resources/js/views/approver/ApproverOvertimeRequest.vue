                ...
                <div class="modal-dialog modal-lg">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <ManageOvertimeRequest :userinfo="$root.userinfo" :selected="selected"></ManageOvertimeRequest>
                        </div>
                    </div>
                </div>
            </div> <!---END MODAL-->
...
<script>
import ManageOvertimeRequest from '../../components/public/ManageOvertimeRequest';
...
export default {
    ...
    methods:{
        ...
        updateRow(val)
        {
            let row = this.$data.rows;
            row.forEach((item, index)=>{
                if(item.overtimeID == val.overtimeID)
                {
                    let data = item;
    ...
    mounted(){
        ...
        axios.get('api/approvalOvertimerequest').then((response)=>{
            this.loader = false;
        ...
        // APPROVERS
        // axios.get('api/getovertimeApprover').then((response)=>{
        ...
        let columnDefs = [
            {
            title: "Overtime ID", data: 'overtimeID', visible: false,
        },
        // {
