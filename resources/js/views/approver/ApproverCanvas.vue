                ...
                <div class="modal-dialog modal-lg">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <ManageCanvas :userinfo="$root.userinfo" :selected="selected"></ManageCanvas>
                        </div>
                    </div>
                </div>
            </div> <!---END MODAL-->
...
<script>
import ManageCanvas from '../../components/public/ManageCanvas';
...
export default {
    ...
    mounted(){
        ...
        axios.get('api/approvalCanvasRequest').then((response)=>{
            this.loader = false;
        ...
        let columnDefs = [
        {
            title: "CANVAS ID", data: 'canvasID', visible: false,
        },
        {
