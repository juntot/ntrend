                ...
                <div class="modal-dialog modal-lg">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <ManageCallingCardRequest :userinfo="$root.userinfo" :selected="selected"></ManageCallingCardRequest>
                        </div>
                    </div>
                </div>
            </div> <!---END MODAL-->
...
<script>
import ManageCallingCardRequest from '../../components/public/ManageCallingCardRequest';
let check = ['<i class="fas fa-times"></i>', '<i class="fas fa-check"></i>'];
let status = ['Pending', 'Approved', 'Rejected'];

export default {
    components:{
        ManageCallingCardRequest
    },
    data(){
        return{
            formtitle: '',
    ...
    mounted(){
        ...
        axios.get('api/approvalCallingCardRequest').then((response)=>{
            this.loader = false;
        ...
        let columnDefs = [
        {
            title: "CC ID", data: 'ccID', visible: false,
        },
        {
