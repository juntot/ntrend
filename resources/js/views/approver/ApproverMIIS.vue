                ...
                <div class="modal-dialog modal-lg">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <ManageMIIS :userinfo="$root.userinfo" :selected="selected"></ManageMIIS>
                        </div>
                    </div>
                </div>
            </div> <!---END MODAL-->
...
<script>
import ManageMIIS from '../../components/public/ManageMIIS';
...
export default {
    ...
    mounted(){
        ...
        axios.get('api/approvalMIISRequest').then((response)=>{
            this.loader = false;
        ...
        let columnDefs = [
        {
            title: "MIIS ID", data: 'miisID', visible: false,
        },
        {
