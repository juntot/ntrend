                ...
                <div class="modal-dialog modal-lg">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <ManageUrgentCheck :userinfo="$root.userinfo" :selected="selected"></ManageUrgentCheck>
                        </div>
                    </div>
                </div>
            </div> <!---END MODAL-->
...
<script>
import ManageUrgentCheck from '../../components/public/ManageUrgentCheck';
...
export default {
    ...
    mounted(){
        ...
        axios.get('api/approvalUrgentCheckRequest').then((response)=>{
            this.loader = false;
        ...
        let columnDefs = [
            {
            title: "CHECK ID", data: 'urgentID', visible: false,
        },
        {
