                ...
                <div class="modal-dialog modal-lg">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <ManageCompanyLoan :userinfo="$root.userinfo" :selected="selected"></ManageCompanyLoan>
                        </div>
                    </div>
                </div>
            </div> <!---END MODAL-->
...
<script>
import ManageCompanyLoan from '../../components/public/ManageCompanyLoan';
let loantype = [
...
export default {
    ...
    mounted(){
        ...
        axios.get('api/approvalLoanRequest').then((response)=>{
            this.loader = false;
