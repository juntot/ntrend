                ...
                <div class="modal-dialog modal-lg">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <ManageUndertimeRequest :userinfo="$root.userinfo" :selected="selected"></ManageUndertimeRequest>
                        </div>
                    </div>
                </div>
            </div> <!---END MODAL-->
...
export default {
    ...
    mounted(){
        ...
        axios.get('api/approvalUndertimerequest').then((response)=>{
            this.loader = false;
